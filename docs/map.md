...
│   ├── architecture/ (48.5K)
│   │   └── engine/ (48.5K)
│   │       ├── ALGORITHM_Engine.md (5.4K)
│   │       ├── BEHAVIORS_Engine.md (3.8K)
│   │       ├── HEALTH_Engine.md (2.1K)
│   │       ├── IMPLEMENTATION_Engine.md (4.3K)
│   │       ├── OBJECTIVES_Engine.md (2.1K)
│   │       ├── PATTERNS_Engine.md (9.2K)
│   │       ├── SYNC_Engine.md (6.0K)
│   │       ├── V2_SPEC_Airtable_Venice.md (12.5K)
│   │       └── VALIDATION_Engine.md (3.1K)
│   ├── archive/ (414.5K)
│   │   ├── architecture/ (29.5K)
│   │   │   └── unity-quest3-architecture.md (29.5K)
│   │   ├── origins/ (6.9K)
│   │   │   ├── README.md (2.5K)
│   │   │   └── nft-collections.md (4.4K)
│   │   ├── research/ (142.3K)
│   │   │   ├── 01-state-of-art-feasibility.md (16.7K)
│   │   │   ├── 02-design-document.md (30.6K)
│   │   │   ├── 03-design-v2.md (24.3K)
│   │   │   ├── 04-design-detailed.md (30.6K)
│   │   │   ├── 05-design-detailed-clean.md (16.0K)
│   │   │   └── 06-quest3-conception-complete.md (24.1K)
│   │   ├── QUEST_PERFORMANCE_WARDEN.md (22.8K)
│   │   ├── VISION.md (20.6K)
│   │   ├── design-document-v1b.md (16.0K)
│   │   ├── design-document-v2.md (24.3K)
│   │   ├── design-document.md (30.6K)
│   │   ├── design_detailed.md (16.0K)
│   │   ├── design_quest3.md (24.1K)
│   │   ├── network-architecture.md (34.2K)
│   │   ├── research-state-of-art.md (16.7K)
│   │   ├── spatial-workspace-spec.md (16.2K)
│   │   └── (..2 more files)
│   ├── citizens/ (361.5K)
│   │   ├── embodiment/ (110.4K)
│   │   │   ├── ALGORITHM_Embodiment.md (20.1K)
│   │   │   ├── BEHAVIORS_Embodiment.md (13.3K)
│   │   │   ├── IMPLEMENTATION_Embodiment.md (42.3K)
│   │   │   ├── PATTERNS_Embodiment.md (10.4K)
│   │   │   ├── SYNC_Embodiment.md (16.4K)
│   │   │   └── VALIDATION_Embodiment.md (8.0K)
│   │   ├── mind/ (133.6K)
│   │   │   ├── ALGORITHM_Mind.md (28.7K)
│   │   │   ├── BEHAVIORS_Mind.md (14.9K)
│   │   │   ├── IMPLEMENTATION_Mind.md (44.3K)
│   │   │   ├── PATTERNS_Mind.md (13.4K)
│   │   │   ├── SYNC_Mind.md (22.4K)
│   │   │   └── VALIDATION_Mind.md (9.8K)
│   │   └── population/ (117.5K)
│   │       ├── ALGORITHM_Population.md (24.9K)
│   │       ├── BEHAVIORS_Population.md (9.6K)
│   │       ├── IMPLEMENTATION_Population.md (50.4K)
...
│   ├── economy/ (366.6K)
│   │   ├── governance/ (130.8K)
│   │   │   ├── ALGORITHM_Governance.md (43.8K)
│   │   │   ├── BEHAVIORS_Governance.md (10.1K)
│   │   │   ├── IMPLEMENTATION_Governance.md (43.4K)
│   │   │   ├── PATTERNS_Governance.md (10.6K)
│   │   │   ├── SYNC_Governance.md (9.1K)
│   │   │   └── VALIDATION_Governance.md (13.8K)
│   │   ├── simulation/ (115.7K)
│   │   │   ├── ALGORITHM_Simulation.md (46.6K)
│   │   │   ├── BEHAVIORS_Simulation.md (8.5K)
│   │   │   ├── IMPLEMENTATION_Simulation.md (27.8K)
│   │   │   ├── PATTERNS_Simulation.md (10.5K)
│   │   │   ├── SYNC_Simulation.md (7.6K)
│   │   │   └── VALIDATION_Simulation.md (14.6K)
│   │   └── sync/ (120.2K)
│   │       ├── ALGORITHM_Sync.md (30.2K)
│   │       ├── BEHAVIORS_Sync.md (9.4K)
│   │       ├── IMPLEMENTATION_Sync.md (41.2K)
...
│   │   │   ├── IMPLEMENTATION_Deployment.md (26.1K)
│   │   │   ├── PATTERNS_Deployment.md (12.5K)
│   │   │   ├── SYNC_Deployment.md (9.8K)
│   │   │   └── VALIDATION_Deployment.md (17.5K)
│   │   ├── performance/ (106.2K)
│   │   │   ├── ALGORITHM_Performance.md (31.5K)
│   │   │   ├── BEHAVIORS_Performance.md (8.2K)
│   │   │   ├── IMPLEMENTATION_Performance.md (25.1K)
...
│   ├── narrative/ (430.4K)
│   │   ├── events/ (154.5K)
│   │   │   ├── ALGORITHM_Events.md (44.6K)
│   │   │   ├── BEHAVIORS_Events.md (11.0K)
│   │   │   ├── IMPLEMENTATION_Events.md (61.5K)
│   │   │   ├── PATTERNS_Events.md (14.3K)
│   │   │   ├── SYNC_Events.md (12.5K)
│   │   │   └── VALIDATION_Events.md (10.5K)
│   │   ├── graph/ (141.3K)
│   │   │   ├── ALGORITHM_Graph.md (44.3K)
│   │   │   ├── BEHAVIORS_Graph.md (11.2K)
│   │   │   ├── IMPLEMENTATION_Graph.md (53.5K)
│   │   │   ├── PATTERNS_Graph.md (11.6K)
│   │   │   ├── SYNC_Graph.md (13.1K)
│   │   │   └── VALIDATION_Graph.md (7.6K)
│   │   └── physics/ (134.6K)
│   │       ├── ALGORITHM_Physics.md (49.0K)
│   │       ├── BEHAVIORS_Physics.md (11.4K)
│   │       ├── IMPLEMENTATION_Physics.md (45.0K)
│   │       ├── PATTERNS_Physics.md (14.9K)
│   │       ├── SYNC_Physics.md (4.0K)
│   │       └── VALIDATION_Physics.md (10.3K)
│   ├── voice/ (190.1K)
│   │   ├── pipeline/ (88.1K)
│   │   │   ├── ALGORITHM_Pipeline.md (17.1K)
│   │   │   ├── BEHAVIORS_Pipeline.md (9.7K)
│   │   │   ├── IMPLEMENTATION_Pipeline.md (19.1K)
│   │   │   ├── PATTERNS_Pipeline.md (11.2K)
│   │   │   ├── SYNC_Pipeline.md (16.9K)
│   │   │   └── VALIDATION_Pipeline.md (14.1K)
│   │   └── spatial/ (102.0K)
│   │       ├── ALGORITHM_Spatial.md (29.7K)
│   │       ├── BEHAVIORS_Spatial.md (8.1K)
│   │       ├── IMPLEMENTATION_Spatial.md (26.3K)
...
│   │   │   ├── IMPLEMENTATION_Atmosphere.md (32.9K)
...
│   │   └── navigation/ (140.5K)
│   │       ├── ALGORITHM_Navigation.md (46.8K)
│   │       ├── BEHAVIORS_Navigation.md (11.6K)
│   │       ├── IMPLEMENTATION_Navigation.md (40.4K)
│   │       ├── PATTERNS_Navigation.md (13.9K)
│   │       ├── SYNC_Navigation.md (9.1K)
│   │       └── VALIDATION_Navigation.md (18.6K)
│   ├── 00_MAP_Venezia.md (16.8K)
│   ├── 04_ALGORITHM_Venezia.md (11.1K)
│   ├── 06_IMPLEMENTATION_Venezia.md (10.5K)
│   ├── 07_SYNC_Venezia.md (18.6K)
│   ├── CONCEPT_Cross_Repo_Integration.md (14.1K)
│   ├── ESTIMATION_Complexity_Matrix.md (20.3K)
...
│       └── zones.js (3.4K)
├── tests/ (5.8K)
│   ├── test_biography.py (3.5K)
│   ├── test_consent.py (2.3K)
│   └── (..1 more files)
├── unity/ (107.9K)
│   ├── Assets/ (25.8K)
│   │   └── _Project/ (25.8K)
│   │       └── Scripts/ (25.8K)
│   │           ├── Billboard.cs (507)
│   │           ├── BootstrapScene.cs (3.7K)
│   │           ├── FoveationSetup.cs (1.5K)
│   │           ├── IslandBuilder.cs (9.5K)
│   │           ├── OceanSimple.cs (588)
│   │           ├── TeleportBeacon.cs (2.8K)
│   │           ├── XRHandSetup.cs (2.1K)
│   │           └── ZoneManager.cs (5.1K)
│   ├── BUILD_GUIDE.md (37.0K)
│   ├── FAILFAST.md (2.9K)
│   ├── MIGRATION_MAP.md (7.4K)
│   ├── POST_HEADSET_PLAN.md (14.3K)
│   ├── PREFLIGHT.md (6.5K)
...
**Sections:**
- # Origins — The Floating Cities of Light (2022)
- ## The First Iteration
- ## The Transformation (2022 → 2026)
- ## Source Videos (Terreau)
- ## The Deck

**Sections:**
- # Cities of Light — NFT Collection Heritage
- ## Collections
- ## Contracts Summary
- ## Current State
...
**Code refs:**
- `src/client/citizens/citizen-avatar.js`
...
**Doc refs:**
- `docs/00_MAP_Venezia.md`
- `docs/02_PATTERNS_Venezia.md`
- `docs/04_ALGORITHM_Venezia.md`
- `docs/06_IMPLEMENTATION_Venezia.md`
- `docs/07_SYNC_Venezia.md`
...
**Code refs:**
- `src/client/citizens/citizen-manager.js`
...
**Doc refs:**
- `docs/00_MAP_Venezia.md`
- `docs/05_VALIDATION_Venezia.md`
- `docs/06_IMPLEMENTATION_Venezia.md`
- `docs/citizens/embodiment/PATTERNS_Embodiment.md`
...
- ## Core Principle: Politics Is Something You Walk Into
- ## Grievance Scenes: Citizens Posting Complaints
- ## Council Gatherings: Citizens Assembling
- ## Political Movements: Aligned Grievances
- ## Guard Enforcement
- ## Governance Outcomes in the World
- ## The Doge System
- ## The Visitor's Political Position
- ## What Does NOT Happen
- ## Testing Governance Behaviors

**Code refs:**
- `backend/engine/activity_creators/file_grievance_activity_creator.py`
- `backend/engine/activity_creators/support_grievance_activity_creator.py`
- `backend/engine/activity_processors/support_grievance_processor.py`
- `backend/engine/council_deliberation.py`
- `backend/engine/decrees/affectpublicbuildingstolandowners.py`
- `backend/engine/handlers/governance.py`
- `backend/engine/handlers/governance_kinos.py`
...
**Code refs:**
- `activity_creators/file_grievance_activity_creator.py`
- `activity_creators/support_grievance_activity_creator.py`
- `activity_processors/file_grievance_processor.py`
- `activity_processors/support_grievance_processor.py`
- `governance.py`
- `governance_kinos.py`
- `index.js`
- `rooms.js`
- `stratagem_processors/organize_gathering_stratagem_processor.py`
- `stratagem_processors/political_campaign_stratagem_processor.py`
- `stratagem_processors/printing_propaganda_stratagem_processor.py`
- `stratagem_processors/reputation_assault_stratagem_processor.py`
...
**Code refs:**
- `attend_theater_performance_processor.py`
- `construct_building_processor.py`
- `createActivities.py`
- `deliver_resource_batch_processor.py`
- `drink_at_inn_activity_processor.py`
- `eat_processor.py`
- `fishing_processor.py`
- `governance.py`
- `governance_kinos.py`
- `inventory.py`
- `leave_venice_processor.py`
- `leisure.py`
- `main.py`
- `management.py`
- `needs.py`
- `orchestrator.py`
- `pray_processor.py`
- `process_work_on_art.py`
- `production_processor.py`
- `rest_processor.py`
- `scheduler.py`
- `social.py`
- `spread_rumor_activity_processor.py`
- `src/server/index.js`
- `src/shared/districts.js`
- `support_grievance_processor.py`
- `talk_publicly_processor.py`
- `work.py`
...
**Code refs:**
- `deliver_to_building_processor.py`
- `file_grievance_activity_creator.py`
- `file_grievance_processor.py`
- `goto_work_activity_creator.py`
- `manage_public_sell_contract_creator.py`
- `production_activity_creator.py`
- `production_processor.py`
...
**Code refs:**
- `attend_mass_creator.py`
- `attend_theater_performance_creator.py`
- `backend/engine/utils/activity_helpers.py`
- `backend/engine/utils/conversation_helper.py`
- `backend/engine/utils/mood_helper.py`
- `backend/engine/utils/thinking_helper.py`
- `buy_listed_land_creator.py`
- `construct_building_creator.py`
- `deliver_resource_batch_activity_creator.py`
- `deliver_to_building_activity_creator.py`
- `draft_blueprint_activity_creator.py`
- `drink_at_inn_activity_creator.py`
- `fetch_from_storage_activity_creator.py`
- `file_grievance_activity_creator.py`
- `goto_home_activity_creator.py`
- `goto_location_activity_creator.py`
- `goto_work_activity_creator.py`
- `governance.py`
- `governance_kinos.py`
- `initiate_building_project_creator.py`
...
- `production_activity_creator.py`
- `read_book_activity_creator.py`
- `reputation_assault_stratagem_processor.py`
- `reputation_boost_stratagem_processor.py`
- `request_loan_creator.py`
- `send_message_creator.py`
- `spread_rumor_activity_creator.py`
- `study_literature_activity_creator.py`
- `supplier_lockout_stratagem_processor.py`
- `support_grievance_activity_creator.py`
- `talk_publicly_activity_creator.py`
- `theater_conspiracy_stratagem_processor.py`
- `work_on_art_creator.py`
...
**Doc refs:**
- `docs/CONCEPT_Cross_Repo_Integration.md`
...
**Code refs:**
- `ngram/engine/physics/graph/graph_interface.py`
- `ngram/engine/physics/graph/graph_ops.py`
- `ngram/engine/physics/tick_runner.py`
- `poc_mind_context_assembly.py`
- `scripts/seed_venice_graph.py`
- `tick_v1_2.py`
...
- `index.js`
- `inject.js`
- `ngram/engine/infrastructure/tempo/tempo_controller.py`
- `ngram/engine/physics/constants.py`
- `ngram/engine/physics/embeddings.py`
- `ngram/engine/physics/graph/graph_ops.py`
- `ngram/engine/physics/graph/graph_queries.py`
...
- `garmin_reader.py`
- `scene.js`
- `src/client/atmosphere/weather.js`
- `src/client/scene.js`
- `src/shared/zones.js`
...
- `main.js`
- `src/client/main.js`
- `src/client/venice/collision.js`
- `src/client/venice/gondola.js`
...
- `src/client/main.js`
- `src/client/network.js`
- `src/client/perception.js`
- `src/client/scene.js`
- `src/client/sculpture.js`
- `src/client/voice.js`
- `src/client/waypoints.js`
- `src/server/index.js`
- `src/server/perception.js`
...
- `manemus/routes/citizens.py`
- `manemus/scripts/account_balancer.py`
- `manemus/scripts/backlog.py`
- `manemus/scripts/garmin_reader.py`
- `manemus/scripts/project_scanner.py`
- `manemus/scripts/telegram_bridge.py`
...
- `docs/CONCEPT_Cross_Repo_Integration.md`
- `docs/citizens/embodiment/PATTERNS_Embodiment.md`
- `docs/narrative/events/PATTERNS_Events.md`
- `docs/narrative/graph/PATTERNS_Graph.md`
...
**Definitions:**
- `def setup()`
- `def test_match_returns_answer()`
- `def test_no_match()`
- `def test_consent_gate()`
- `def test_red_line_blocks()`
- `def test_load_segments()`
- `def test_match_question_best_overlap()`
...
- `def test_consent_denied_no_directive()`
- `def test_consent_denied_wrong_mode()`
- `def test_revoke()`
- `def test_red_lines_returned()`
...
**Sections:**
- # cities-of-light - Agent Instructions
- # Working Principles
